...
class TestTimes(unittest.TestCase):
    ...
    def test_earliest_tallit_tefillin(self):
        self.assertEqual(self.CityTimes.earliest_tallit_tefillin(), "06:30")

    def test_sunrise(self):
        self.assertEqual(self.CityTimes.sunrise(), "07:16")

    def test_latest_shema(self):
        self.assertEqual(self.CityTimes.latest_shema(), "10:00")

    def test_latest_shacharit(self):
        self.assertEqual(self.CityTimes.latest_shacharit(), "10:56")
    ...
    def test_shaah_zmanit(self):
        self.assertEqual(round(self.CityTimes.shaah_zmanit() * 60, 2), 56.37)
